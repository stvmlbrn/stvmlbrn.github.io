...
To get started, let mock up a simple React component that fetches some data
...
in the component state, and update the DOM to reflect the changes in the `ResultsTable` component. But we will not
